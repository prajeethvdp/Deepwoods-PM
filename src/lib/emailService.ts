...
const DEEPWOODS_LOGO_URL = "https://raw.githubusercontent.com/prajeethvdp/Deepwoods-PM/main/public/logo.png";
    ...
    <div style="margin-top: 32px; padding-top: 16px; border-top: 1px solid #f1f5f9;">
      ...
      <div>
        <div style="margin: 8px 0 10px 0;">
          <img src="${DEEPWOODS_LOGO_URL}" alt="DEEPWOODS GREEN®" style="height: 52px; width: auto; max-width: 240px; display: block; border: 0;" />
        </div>
