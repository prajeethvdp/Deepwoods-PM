    ...
    <div style="margin-top: 32px; padding-top: 16px; border-top: 1px solid #f1f5f9;">
      ...
      <div>
        <div style="margin: 8px 0 10px 0;">
          <img src="data:image/png;base64,${DEEPWOODS_LOGO_BASE64}" alt="DEEPWOODS GREEN®" style="height: 52px; width: auto; max-width: 240px; display: block; border: 0;" />
        </div>
